        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <!-- Preço de Compra -->
                    <div>
                        <label for="purchase_price" class="block text-sm font-medium text-gray-700 mb-1">Preço de Compra (R$)</label>
                ...
                <div class="mt-6" x-data="{ selectedSizes: [] }">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Tamanhos Disponíveis <span class="text-red-500">*</span></label>
