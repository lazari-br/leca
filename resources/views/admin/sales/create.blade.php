        ...
        <form method="POST" action="{{ route('admin.sales.store') }}" id="sales-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="customer_name" id="customer_name" class="w-full border-gray-300 rounded" placeholder="Nome do cliente" value="{{ old('customer_name') }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="sale_date" id="sale_date" class="w-full border-gray-300 rounded flatpickr placeholder-gray-400" placeholder="Selecione a data" value="{{ old('sale_date', date('Y-m-d')) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="payment_date" id="payment_date" class="w-full border-gray-300 rounded flatpickr placeholder-gray-400" placeholder="Selecione a data" value="{{ old('payment_date') }}" required>
