        ...
        <form method="POST" action="{{ route('admin.purchases.update', $purchase->id) }}" id="purchase-form">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="supplier_name" id="supplier_name" class="w-full border-gray-300 rounded" placeholder="Nome do fornecedor" value="{{ old('supplier_name', $purchase->supplier_name) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="purchase_date" id="purchase_date" class="w-full border-gray-300 rounded flatpickr placeholder-gray-400" placeholder="Selecione a data" value="{{ old('purchase_date', $purchase->purchase_date ? \Carbon\Carbon::parse($purchase->purchase_date)->format('d-m-Y') : '') }}" required>
                ...
                <div>
                    ...
                    <input type="number" name="installments" id="installments" class="w-full border-gray-300 rounded" placeholder="Qtd de parcelas" value="{{ old('installments', $purchase->installments) }}" min="1" required>
            ...
            <div class="mt-6">
                <button type="submit" class="bg-green-600 text-white px-6 py-2 rounded">Atualizar Compra</button>
            </div>
        </form>
    </div>
